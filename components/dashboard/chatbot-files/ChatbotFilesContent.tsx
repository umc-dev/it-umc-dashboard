...
export function ChatbotFilesContent() {
  const { data: files, isLoading, isError } = useChatbotFiles();
  ...
  return (
    <div className="max-w-6xl mx-auto py-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <FormHeader
          title="File Chatbot"
          description="Unggah dokumen PDF atau Excel sebagai sumber pengetahuan (knowledge base) dinamis untuk AI Chatbot."
        />
