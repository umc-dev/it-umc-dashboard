...
const GoogleIcon = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 shrink-0">
      ...
      <div className="w-full max-w-sm flex flex-col items-center text-center space-y-8">
        <div className="space-y-4">
          <div className="flex justify-center">
            <div className="p-3 bg-blue-50/50 rounded-2xl border border-blue-100/50 shadow-sm">
              <Image src="/logo.svg" alt="Logo" width={56} height={56} className="w-12 h-12" />
            </div>
          </div>
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">Selamat Datang</h2>
        ...
        <div className="w-full space-y-5 pt-2">
          <button
            ...
            disabled={isLoading}
            className="group relative w-full flex items-center justify-center gap-3 px-6 py-4 border border-gray-200 rounded-2xl text-gray-700 bg-white hover:bg-gray-50 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/5 focus:outline-none focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading ? (
          ...
          <div className="bg-blue-50/60 border border-blue-100 rounded-xl p-4 flex items-start gap-3 text-left">
            ...
            <p className="text-xs text-blue-700 leading-relaxed font-medium">
              Mohon gunakan email institusi <span className="font-bold">@umc.ac.id</span> Anda.
            </p>
          </div>
        </div>
